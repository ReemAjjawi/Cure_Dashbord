...
class _ShowSubjectsState extends State<ShowSubjects> {
          ...
          body: SafeArea(
            child: BlocConsumer<SubjectsBloc, SubjectsState>(
              listener: (context, state) {
                ...
                } else if (state is SuccessDeleteSubject) {
                  _showSuccessDialogDeleteSubject(context).then((_) {
  ...
  Future<void> _showSuccessDialogDeleteSubject(BuildContext context) {
    return showDialog(
      context: context,
