...
class _ShowLecturesState extends State<ShowLectures> {
  ...
  void navigateToHomeScreen(BuildContext context, int index) {
        ...
        return Scaffold(
          ...
          body: SafeArea(
            child: BlocConsumer<LecturesBloc, LecturesState>(
              listener: (context, state) {
                ...
                } else if (state is SuccessDeleteLecture) {
                  _showSuccessDialogDeleteLecture(context).then((_) {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ShowLectures(
          ...
          bottomNavigationBar: Padding(
            ...
            child: BottomNavigationBar(
              ...
              onTap: (index) {
                navigateToHomeScreen(context, index);
              },
            ),
          ),
        );
...
Future<void> _showSuccessDialogDeleteLecture(BuildContext context) {
  return showDialog(
    context: context,
