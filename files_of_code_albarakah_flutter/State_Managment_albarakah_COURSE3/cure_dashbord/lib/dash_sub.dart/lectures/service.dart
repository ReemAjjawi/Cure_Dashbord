...
import 'models/request/lecture_post_model.dart';
...
abstract class LectureService extends Service {
  ...
  Future<String> deleteLecture(int lectureId);
...
class LectureServiceImp extends LectureService {
  ...
  @override
  Future<String> deleteLecture(int lectureId) async {
    try {
      response = await dio.delete(
        "${AppUrl.baseUrl}${AppUrl.addLectures}/$lectureId",
        options: HeaderConfig.getHeader(useToken: true),
      );
