                  ...
                  BlocConsumer<SubjectsBloc, SubjectsState>(
                    ...
                    return BlocConsumer<StatisticsBloc, StatisticsState>(
                      ...
                      builder: (context, secondstate) {
                        if (firstState is SubjectsLoading ||
                          ...
                          return Expanded(
                            child: GridView.builder(
                              ...
                              itemCount: secondstate.num.length,
                              itemBuilder: (context, index) {
                                return Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        secondstate.num[index].subjectName,
                        ...
                        } else if (secondstate is FailureStatisticsState) {
                          return Text((secondstate).message);
                        } else if (firstState is FailureSubjectsState) {
                          return Text((firstState).message);
                        } else if (firstState is SuccessDeleteSubject) {
